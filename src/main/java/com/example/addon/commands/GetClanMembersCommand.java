 ...
 * Usage: .getclanmembers <clanName>
 */
public class GetClanMembersCommand extends Command {
    ...
    public GetClanMembersCommand() {
        super("getclanmembers", "Parses clan members from /clan info GUI.");
    }
    ...
    private void info(String message) {
        ChatUtils.info("GetClanMembers: " + message);
    }

    private void warning(String message) {
        ChatUtils.warning("GetClanMembers: " + message);
    }

    private void error(String message) {
        ChatUtils.error("GetClanMembers: " + message);
    }
}
