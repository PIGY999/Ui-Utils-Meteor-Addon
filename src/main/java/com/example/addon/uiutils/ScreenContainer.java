...
public abstract class ScreenContainer {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        boolean control = System.getProperty("os.name").toLowerCase().contains("mac") ? modifiers == GLFW_MOD_SUPER : modifiers == GLFW_MOD_CONTROL;
    ...
    public void renderCustom(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        RENDERER.renderTooltip(context, mouseX, mouseY, delta / 20);
